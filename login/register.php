<?php
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if (empty($name)) {
			...
			$error = true;
			$nameError = "Application Number must have 16 Charactrs.";
		} 
		...
		if (empty($email)) {
			...
			$query = "SELECT * FROM personalinfo_tbl WHERE PhoneNumber='$email' and AppNumber='$name'";
		...
		$confirm = mysqli_query($conn,"SELECT * FROM payment_tbl WHERE AppNumber='$name' and Status='1' ");
...
<title>Yabatech-CCS Part-Aplication - Sign Up</title>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" required pattern="YCT/CCS/18/.+[0-9]{4}" name="name" onkeyup="this.value = this.value.toUpperCase();" class="form-control" placeholder="Your Application Number (e.g. YCT/CCS/18/XXXXX)" value="<?php echo @$name; ?>" maxlength="16" />
                </div>
