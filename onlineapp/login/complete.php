...
<table width="100%" border="0" class="table table-striped" style="font-size:13px">
<tr>
  ...
  <tr>
    <td height="33" colspan="3" style="color:#060"><strong>PERSONAL INFORMATION (SECTION A)</strong></td>
    </tr>
  <tr>

        <td width="50%"><strong>Date of Birth:</strong> <span><?php echo $dob; ?></span></td>
        <td width="50%" colspan="2"><strong>Gender:</strong> <span><?php echo $gender; ?></span></td>
      </tr>
      <tr>
        <td><strong>State of Origin:</strong> <span><?php echo $state; ?></span></td>
        <td colspan="2"><strong>L.G.A.:</strong> <span><?php echo $lga; ?></span></td>
      </tr>
      <tr>
        <td colspan="3"><strong>Residential Address:</strong> <span><?php echo $houseadd; ?></span></td>
      </tr>
  <tr>
    <td height="34" colspan="3" style="color:#060"><strong>ACADEMIC INFORMATION (SECTION B)</strong></td>
    </tr>
  <tr>
...
<?php }?>  <tr>
    <td height="36" colspan="3"  style="color:#060"><strong>PARENTS/GUARDIAN INFORMATION (SECTION C)</strong></td>
    </tr>
  <tr>
  ...
  <tr>
    <td height="32" colspan="3"  style="color:#060"><strong>NEXT OF KIN INFORMATION (SECTION D)</strong></td>
    </tr>
  <tr>
  ...
  <tr>
    <td height="33" colspan="3" style="color:#060"><strong>O'LEVEL INFORMATION (SECTION E) <?php echo $show; ?> SITTING(s)</strong><span></span></td>
    </tr>
  <tr>
    <td colspan="3"><table width="100%" border="0">
      <tr>
      ...
      <tr>
    <td colspan="3" style="color:#F00"><h6>By Submitting this form you have agreed to our terms and conditions. Ensure you always check here to be updated when you have been offered admission. <strong>NOTE: </strong>Printing must be in colored</h6></td>
    </tr>  
      <tr>
    <td colspan="3"></td>
    </tr>  
