<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		$confirm = mysqli_query($conn,"SELECT * FROM payment_tbl WHERE AppNumber='$email' and Status='1' ");
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" required pattern="YCT/CCS/18/.+[0-9]{4}" name="email" onkeyup="this.value = this.value.toUpperCase();" class="form-control" placeholder="Your Application Number (e.g. YCT/CCS/18/XXXXX)" value="<?php echo @$email; ?>" maxlength="16" />
                </div>
